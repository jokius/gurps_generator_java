...
class NotManArmor : Model, Armor {
    ...
    constructor(result: ResultSet) {
        id = result.getInt("id")
        val raceRes = result.getString("race")
        if (raceRes != null) race = raceRes
    ...
    override fun addToCharacter(character: Character) {
        CharactersNotManArmor(character.id, id, count).create()
    ...
    override fun removeToCharacter(character: Character) {
        ...
        CharactersNotManArmor().find_by(params).destroy()
    }
}
