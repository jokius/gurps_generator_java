...
import ru.gurps.generator.desktop.controller.helpers.FeaturesAbstractController;
...
public class AdvantagesController extends AbstractController {
    ...
    private void initialize() {
        new FeaturesAbstractController(tableView, addonsTableView, name, nameEn, featureType, cost, description, bottomMenu, lvlComboBox,
                ...
                searchName, searchNameEn, searchCost, searchDescription, reset, searchText, true);
    }
}
